...
- Right click on adt_job.rcl > Run As > 1 IRI Job.

The RowGen job script will generate all HL7 messages to a single file. To place generated HL7 messages in separate
out files a bat program can be used. You can view the bat program implementation in project HL7_ADT_A04.
