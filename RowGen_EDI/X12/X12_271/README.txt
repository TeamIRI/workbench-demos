This proof of concept demonstrates the use of RowGen job scripts (x12_271_no_dependents.rcl and x12_271_w_dependents.rcl) to generate 271 X12 messages.
...
The X12_271 project contains a simple batch script that will execute the two RowGen scripts.
One .rcl script will create an 271 X12 message where a dependent is present the other .rcl script will
create a 271 message with no dependents.
