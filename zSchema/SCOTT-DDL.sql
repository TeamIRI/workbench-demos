...
ALTER TABLE SCOTT.SUB_SALE_DIM DROP CONSTRAINT SUB_SALE_DIM_FK1;

ALTER TABLE SCOTT.SUB_SALE_DIM DROP CONSTRAINT SUB_SALE_DIM_FK2;

ALTER TABLE SCOTT.SUB_SALE_DIM DROP CONSTRAINT SUB_SALE_DIM_FK3;

ALTER TABLE SCOTT.SUB_SALE_DIM DROP CONSTRAINT SUB_SALE_DIM_FK4;

ALTER TABLE SCOTT.SUB_SALE_DIM DROP CONSTRAINT SUB_SALE_DIM_FK5;

ALTER TABLE SCOTT.SUB_SALE_DIM DROP CONSTRAINT SUB_SALE_DIM_FK6;

ALTER TABLE SCOTT.SUB_SALE_DIM DROP CONSTRAINT SUB_SALE_DIM_FK7;

ALTER TABLE SCOTT.SUB_CATEGORY_DIM DROP CONSTRAINT SUB_CATEGORY_DIM_PK;

ALTER TABLE SCOTT.SUB_DEPT_DIM DROP CONSTRAINT SUB_DEPT_DIM_PK ;

ALTER TABLE SCOTT.SUB_EMP_DIM DROP CONSTRAINT SUB_EMP_DIM_PK;

ALTER TABLE SCOTT.SUB_EMP_SALARY_RANGE_DIM DROP CONSTRAINT SUB_EMP_SALARY_RANGE_DIM_PK ;

ALTER TABLE SCOTT.SUB_ITEM_DIM DROP CONSTRAINT SUB_ITEM_DIM_PK;

ALTER TABLE SCOTT.SUB_ITEM_PRICE_RANGE_DIM DROP CONSTRAINT SUB_ITEM_PRICE_RANGE_DIM_PK;

ALTER TABLE SCOTT.SUB_PROJECT_DIM DROP CONSTRAINT SUB_PROJECT_DIM_PK;

ALTER TABLE SCOTT.SUB_SALE_DIM ADD CONSTRAINT SUB_SALE_DIM_PK;
...
DROP TABLE SCOTT.SUB_CATEGORY_DIM;

DROP TABLE SCOTT.SUB_DEPT_DIM;

DROP TABLE SCOTT.SUB_EMP_DIM;

DROP TABLE SCOTT.SUB_EMP_SALARY_RANGE_DIM;

DROP TABLE SCOTT.SUB_ITEM_DIM;

DROP TABLE SCOTT.SUB_ITEM_PRICE_RANGE_DIM;

DROP TABLE SCOTT.SUB_PROJECT_DIM;

DROP TABLE SCOTT.SUB_SALE_DIM;
